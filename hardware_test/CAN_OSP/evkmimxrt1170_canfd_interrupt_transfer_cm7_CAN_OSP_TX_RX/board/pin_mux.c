...
void BOARD_InitPins(void) {
  ...
  CLOCK_EnableClock(kCLOCK_Iomuxc_Lpsr);      /* LPCG on: LPCG is ON. */
	...
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_10_GPIO9_IO09, 0U);			//IN_OENA
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_09_GPIO9_IO08, 0U);			//OUT_OENA
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_08_GPIO9_IO07, 0U);			//CINT
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_07_GPIO9_IO06, 0U);			//DIRL
	IOMUXC_SetPinMux(IOMUXC_GPIO_AD_06_GPIO9_IO05, 0U);			//MSEL
  ...
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_AD_30_FLEXCAN2_TX,        /* GPIO_LPSR_00 is configured as FLEXCAN3_TX */
	  1U);                                    /* Software Input On Field: Force input path of pad GPIO_LPSR_00 */
  IOMUXC_SetPinMux(
	  IOMUXC_GPIO_AD_31_FLEXCAN2_RX,        /* GPIO_LPSR_01 is configured as FLEXCAN3_RX */
	  1U);                                    /* Software Input On Field: Force input path of pad GPIO_LPSR_01 */
