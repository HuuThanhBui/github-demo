...
int main(void)
{
    ...
    GPIO_PinInit(GPIO9, 28, &led_config);			//STB Pin
    GPIO_PinInit(GPIO9, 29, &led_config);			//En Pin
...
/* Setup Tx Message Buffer. */
    ...
    GPIO_PinWrite(GPIO9, 28, 1);			//STB Pin
    GPIO_PinWrite(GPIO9, 29, 1);			//En Pin

//    GPIO_PinWrite(GPIO9, 28, 0);			//STB Pin
//    GPIO_PinWrite(GPIO9, 29, 1);			//En Pin
    ...
    while (true)
    {
        ...
        else
        {
            ...
            if((frame.id >> CAN_ID_STD_SHIFT) == 0x321 && frame.dataByte0 == 0x99)
            {
