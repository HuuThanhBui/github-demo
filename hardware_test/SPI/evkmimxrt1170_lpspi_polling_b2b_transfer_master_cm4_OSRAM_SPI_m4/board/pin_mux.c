...
void BOARD_InitPins(void) {
  ...
  IOMUXC_SetPinMux(
		...
		0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  IOMUXC_SetPinMux(
	    IOMUXC_GPIO_DISP_B2_12_LPSPI4_SCK,           /* GPIO_AD_28 is configured as LPSPI1_SCK */
		0U);                                    /* Software Input On Field: Input Path is determined by functionality */


  IOMUXC_SetPinMux(
	    IOMUXC_GPIO_DISP_B2_14_LPSPI4_SOUT,          /* GPIO_AD_30 is configured as LPSPI1_SOUT */
		0U);                                    /* Software Input On Field: Input Path is determined by functionality */
  ...
  IOMUXC_SetPinConfig(
		...
		0x02U);                                 /* Slew Rate Field: Slow Slew Rate
												   ...
												   Domain write protection lock: Neither of DWP bits is locked */
  IOMUXC_SetPinConfig(
	    IOMUXC_GPIO_DISP_B2_12_LPSPI4_SCK,           /* GPIO_AD_28 PAD functional properties : */
		0x02U);                                 /* Slew Rate Field: Slow Slew Rate
												   Drive Strength Field: high drive strength
												   Pull / Keep Select Field: Pull Disable, Highz
												   Pull Up / Down Config. Field: Weak pull down
  ...
  IOMUXC_SetPinConfig(
	    IOMUXC_GPIO_DISP_B2_14_LPSPI4_SOUT,          /* GPIO_AD_30 PAD functional properties : */
		0x02U);                                 /* Slew Rate Field: Slow Slew Rate
												   Drive Strength Field: high drive strength
												   Pull / Keep Select Field: Pull Disable, Highz
												   Pull Up / Down Config. Field: Weak pull down
